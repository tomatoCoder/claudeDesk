...
<template>
  <aside class="app-sidebar">
    <header class="brand"><img class="brand-logo" :src="appLogo" alt="" /><span>Claude Desk</span><button class="icon-button add" type="button" title="添加项目" @click="emit('addProject')"><Plus :size="18" /></button></header>
