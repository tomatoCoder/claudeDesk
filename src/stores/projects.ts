...
export const useProjectsStore = defineStore('projects', () => {
  ...
  const settings = ref<AppSettingsDto>({ claudePath: null, sidebarWidth: 280, theme: 'system', language: 'zh-CN', openWith: 'default', terminalApp: 'default', permissionMode: 'default' })
